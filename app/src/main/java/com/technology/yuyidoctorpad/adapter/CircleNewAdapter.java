...
/**
 * Created by liuhaidong on 2017/11/2.
 */

public class CircleNewAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater mInflater;
    private CircleNewHolder circleHolder;
    ...
    public CircleNewAdapter(Context mContext, List<Rows> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            circleHolder = new CircleNewHolder();
