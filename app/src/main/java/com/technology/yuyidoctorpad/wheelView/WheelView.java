...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.color.white;/*R.drawable.t_user_center_bottom*/;
	private int wheelForeground = R.color.white;/*R.drawable.t_user_center_bottom;*/
	...
	protected void onDraw(Canvas canvas) {
		...
		if (viewAdapter != null && viewAdapter.getItemsCount() > 0) {
			...
			if (title!=null&&!"".equals(title)){
				...
				paint.setTextSize(getResources().getDimension(R.dimen.wheelViewTextSizeLarge));
				paint.setColor(getResources().getColor(R.color.wheelTextColor));
				Rect bon=new Rect();
